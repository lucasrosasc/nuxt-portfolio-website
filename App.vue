<template>
    <div :class="{ dark: isDarkMode }" class="min-h-screen">
        ...
        >
            ...
            <header
                class="bg-white dark:bg-gray-900 shadow-sm dark:shadow-gray-800 sticky top-0 z-50 transition-colors duration-300"
            >
                <div
                ...
                >
                    ...
                    <div class="flex items-center">
                        <div
                            class="h-10 w-10 bg-gradient-to-r from-purple-600 to-purple-800 dark:from-purple-500 dark:to-purple-700 rounded-md flex items-center justify-center text-white font-bold text-xl"
                        >
                            P
                        </div>
                    ...
                    <nav class="hidden md:flex space-x-8">
                        ...
                        <a
                            href="#"
                            @click.prevent="setRoute('/projects')"
                            :class="
                        ...
                        <a
                            href="#"
                            @click.prevent="setRoute('/contact')"
                            :class="
                ...
                >
                    <div
                        class="container mx-auto px-4 py-2 flex flex-col space-y-3"
                    >
                        <a
                            href="#"
                            @click.prevent="
            ...
            <main class="flex-grow">
                ...
                <div v-if="currentRoute === '/'">
                    <!-- Hero Section -->
                    <section
                        class="bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 py-20 transition-colors duration-300"
                    >
                        <div
                        ...
                        >
                            <div class="md:w-1/2 mb-8 md:mb-0">
                                ...
                                <p
                                    class="text-xl text-gray-700 dark:text-gray-300 mb-6"
                                >
                                    A passionate full-stack developer with over
                                    5 years of experience creating beautiful,
                                ...
                                <div class="flex space-x-4">
                                    <button
                                        ...
                                        class="bg-purple-600 hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600 text-white px-6 py-3 rounded-md font-medium transition-colors"
                                    >
                                        View Projects
                                    </button>
                                    <button
                                        @click="setRoute('/contact')"
                                        class="border border-purple-600 dark:border-purple-400 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-gray-800 px-6 py-3 rounded-md font-medium transition-colors"
                                    >
                                        Contact Me
                                    </button>
                                </div>
                            ...
                            <div class="md:w-1/2 flex justify-center">
                                <div
                                    class="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl"
                                >
                                    <img
                    ...
                    <section
                        class="py-16 bg-white dark:bg-gray-900 transition-colors"
                    >
                        <div class="container mx-auto px-4">
                            ...
                            <div
                                class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8"
                            >
                                <div
                                ...
                                >
                                    <div
                                        class="w-16 h-16 mb-3 flex items-center justify-center p-2 rounded-lg bg-gray-50 dark:bg-gray-800 group-hover:bg-purple-50 dark:group-hover:bg-purple-900/20 transition-colors"
                                    >
                                        <img
                                            :src="tech.logo"
                                            :alt="tech.name"
                                    ...
                                    <span
                                        class="text-gray-800 dark:text-gray-200 font-medium text-center"
                                        >{{ tech.name }}</span
                                    >
                                </div>
                            </div>
                    ...
                    <!-- Projects Carousel -->
                    <section
                        class="py-16 bg-gray-50 dark:bg-gray-800 transition-colors"
                    >
                        <div class="container mx-auto px-4">
                            <h2
                                class="text-3xl font-bold text-center mb-4 text-gray-900 dark:text-white"
                            >
                                Featured Projects
                            </h2>
                            <p
                                class="text-gray-600 dark:text-gray-400 text-center mb-12 max-w-2xl mx-auto"
                            >
                                Check out some of my recent work that showcases
                            ...
                            <div class="relative">
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                class="bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
                                            >
                                                <img
                                                    :src="project.image"
                                                    :alt="project.title"
                    ...
                    >
                        <div class="container mx-auto px-4">
                            ...
                            <div
                                class="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg"
                            >
                                <img
                ...
                <div v-if="currentRoute === '/about'">
                    ...
                    <section
                        class="bg-gradient-to-b from-gray-50 dark:from-gray-800 to-white dark:to-gray-900 py-20 transition-colors"
                    >
                        <div
                            class="container mx-auto px-4 flex flex-col md:flex-row items-center"
                        >
                            <div class="md:w-1/2 mb-8 md:mb-0">
                                ...
                                >
                                    ...
                                    5 years of experience creating beautiful,
                                    functional, and user-centered digital
                                    experiences. I specialize in modern web
                                    technologies and have a deep understanding
                                    of both frontend and backend development.
                                </p>
                                <p
                                    class="text-lg text-gray-600 dark:text-gray-400 mb-6"
                                >
                                    My journey in web development started during
                                    my computer science studies, where I
                                    discovered my love for creating interactive
                                    and engaging user interfaces. Since then,
                                    I've worked with startups and established
                                    companies, helping them build scalable web
                                ...
                                >
                                    ...
                                    open-source projects, or sharing my
                                    knowledge through blog posts and community
                                    talks. I believe in continuous learning and
                            ...
                            <div class="md:w-1/2 flex justify-center">
                                <div
                                    class="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-xl"
                                >
                                    <img
                                        src="/placeholder.svg?height=320&width=320"
                                        alt="Profile Photo"
                        ...
                        <div class="container mx-auto px-4">
                            ...
                            >
                                <div
                                    ...
                                    :key="cert.id"
                                    class="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow"
                                >
                                    <div class="flex items-start">
                                        <div
                                            class="w-16 h-16 flex-shrink-0 mr-4"
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-3">
                                                <span
                                                    class="inline-block bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 text-xs px-3 py-1 rounded-full"
                                                >
                                                    {{ cert.status }}
                                                </span>
                                            </div>
                ...
                <div v-if="currentRoute === '/projects'">
                    ...
                    >
                        <div class="container mx-auto px-4 text-center">
                            ...
                            >
                                Explore my portfolio of web applications, from
                                e-commerce platforms to productivity tools. Each
                                project showcases different technologies and
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <svg
                                                    ...
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    class="lucide lucide-arrow-right ml-1 group-hover:translate-x-1 transition-transform"
                                                >
                                                    <path d="M5 12h14" />
                                                    <path d="m12 5 7 7-7 7" />
                                                </svg>
                    ...
                    >
                        <div class="container mx-auto px-4 text-center">
                            ...
                            >
                                ...
                                I'd love to hear from you. Let's create
                    ...
                    >
                        <div class="container mx-auto px-4">
                            <div class="grid lg:grid-cols-2 gap-12">
                                <!-- Contact Form -->
                                <div
                                    class="bg-gray-50 dark:bg-gray-800 rounded-lg p-8"
                                >
                                    <h2
                                ...
                                <div class="space-y-8">
                                    <div>
                                        ...
                                        >
                                            ...
                                            opportunities, interesting projects,
                                            or just having a chat about
                                    ...
                                    <div class="space-y-6">
                                        <div class="flex items-start space-x-4">
                                            <div
                                                class="bg-purple-100 dark:bg-purple-900/30 p-3 rounded-lg"
                                            >
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="24"
                                                    ...
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    class="lucide lucide-mail text-purple-600 dark:text-purple-400"
                                                >
                                                    <rect
                                                        width="20"
                                                        height="16"
                                        ...
                                        <div class="flex items-start space-x-4">
                                            ...
                                            >
                                                <svg
                                                    ...
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    class="lucide lucide-phone text-blue-600 dark:text-blue-400"
                                                >
                                                    <path
                                        ...
                                        <div class="flex items-start space-x-4">
                                            <div
                                                class="bg-green-100 dark:bg-green-900/30 p-3 rounded-lg"
                                            >
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="24"
                                                    ...
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    class="lucide lucide-map-pin text-green-600 dark:text-green-400"
                                                >
                                                    <path
                                    ...
                                    <div>
                                        ...
                                        <div class="flex space-x-4">
                                            <a
                                                href="#"
                                                class="bg-gray-100 dark:bg-gray-800 p-3 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors"
                                            >
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="24"
                                                    ...
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    class="lucide lucide-github text-gray-600 dark:text-gray-400"
                                                >
                                                    <path
                                                        d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"
                                                    />
                                            ...
                                            <a
                                                href="#"
                                                class="bg-gray-100 dark:bg-gray-800 p-3 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                                            >
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="24"
                                                    ...
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    class="lucide lucide-linkedin text-gray-600 dark:text-gray-400"
                                                >
                                                    <path
                                            ...
                                            >
                                                <svg
                                                    ...
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round"
                                                    class="lucide lucide-twitter text-gray-600 dark:text-gray-400"
                                                >
                                                    <path
                ...
                >
                    <section
                        class="py-20 bg-white dark:bg-gray-900 transition-colors"
                    >
                        <div class="container mx-auto px-4">
                            <div class="max-w-4xl mx-auto">
                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="flex flex-wrap gap-2 mb-6">
                                        ...
                                        >
                                        <span
                                            class="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 px-3 py-1 rounded-full text-sm"
                                            >Node.js</span
                                        >
                                        <span
                                            class="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 px-3 py-1 rounded-full text-sm"
                                            >MongoDB</span
                                        >
                                        <span
                                            class="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-400 px-3 py-1 rounded-full text-sm"
                                            >Stripe</span
                                        >
                                    </div>
                                    <div class="flex space-x-4">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        The project showcases modern web
                                        development practices, including
                                        responsive design, secure payment
                                    ...
                                    <ul
                                        class="list-disc list-inside text-gray-600 dark:text-gray-400 mb-6 space-y-2"
                                    >
                                        <li>
                                        ...
                                        <li>
                                            Product catalog with search and
                                            filtering
                                        </li>
                                        <li>
                                    ...
                                    <p
                                        class="text-gray-600 dark:text-gray-400 mb-6"
                                    >
                                        The frontend was built using Vue.js with
                                        Vuex for state management, providing a
                                        reactive and efficient user interface.
                                        The backend utilizes Node.js with
                                        Express.js, creating RESTful APIs that
                                        communicate with a MongoDB database.
                                        Payment processing is handled securely
                                        through Stripe's API integration.
                                    </p>
                                    ...
                                    <div class="mb-8">
                                        ...
                                        <p
                                            class="text-sm text-gray-500 dark:text-gray-400 text-center"
                                        >
                                            Admin dashboard for inventory and
                                            order management
                                        </p>
                                    </div>
                                    ...
                                    >
                                        ...
                                        to prevent overselling. This was solved
                                        by implementing optimistic locking in
                                        the database and using WebSocket
                                        connections to notify users of stock
                                        changes. Another challenge was ensuring
                                        PCI compliance for payment processing,
                                        which was addressed by using Stripe's
                                    ...
                                    >
                                        ...
                                        thousands of concurrent users and has
                                        processed over $1M in transactions. The
                                        responsive design resulted in a 40%
                                        increase in mobile conversions, and the
                                        intuitive admin interface reduced
                                        inventory management time by 60%.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <svg
                                        ...
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="lucide lucide-mail mr-2 text-gray-400"
                                    >
                                        <rect
                                            width="20"
                                            height="16"
                                ...
                                <div class="flex items-center">
                                    <svg
                                        ...
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="lucide lucide-phone mr-2 text-gray-400"
                                    >
                                        <path
                                            d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"
                                        />
                                ...
                                <div class="flex items-center">
                                    <svg
                                        ...
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="lucide lucide-map-pin mr-2 text-gray-400"
                                    >
                                        <path
                                            d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"
                                        />
...
const featuredProjects = ref([
    ...
    },
    {
        ...
        description:
            "A platform for property listings with advanced search, filtering, and virtual tours.",
        image: "/placeholder.svg?height=400&width=600",
...
const allProjects = ref([
    ...
    },
    {
        ...
        description:
            "Mobile-first weather application with location-based forecasts and severe weather alerts.",
        image: "/placeholder.svg?height=400&width=600",
    ...
    },
    {
        ...
        description:
            "Real-time cryptocurrency price tracking with portfolio management and price alerts.",
        image: "/placeholder.svg?height=400&width=600",
...
const latestBlog = ref({
    ...
    excerpt:
        "Learn the best practices for creating maintainable and scalable frontend applications that can grow with your business needs.",
